                        ...
                        <hr>
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <div class="form-group input-group">
                                        ...
                                        <input name="gaji_pokok" id="gaji_pokok" class="form-control" placeholder="Masukkan Tanggal" value="<?php echo number_format($row_pegawai['gaji_pokok'],0,"",".");?>" style="text-align: right;width: 70%;"  onkeyup="sum();" min="0">
                                    </div>
                                </td>
                                <td width="1%" ></td>
                                <td width="22%">
                                ...
                                <td width="23%">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_pajak" id="pot_pajak" class="form-control" placeholder="Potongan Pajak" onkeyup="sum();" style="text-align: right;" >
                                    </div>
                                </td>
                            </tr>
                            <!--baris 2-->
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_istri" id="tunj_istri" class="form-control" placeholder="Tunj Istri / Suami" style="text-align: right;width: 70%" onkeyup="sum();" > 
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_bpjs" id="pot_bpjs" class="form-control" placeholder="Potongan BPJS" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                </td>
                            </tr>
                            <!-- baris 3 -->
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_anak" id="tunj_anak" class="form-control" placeholder="Tunjangan Anak" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_iwp_21" id="pot_iwp_21" class="form-control" placeholder="Pot IWP 21" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_hselon" id="tunj_hselon" class="form-control" placeholder="Tunjangan Hselon" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_iwp_81" id="pot_iwp_81" class="form-control" placeholder="Pot IWP 81" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_fung_umum" id="tunj_fung_umum" class="form-control" placeholder="Tunjangan Fung Umum" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_tapebum" id="pot_tapebum" class="form-control" placeholder="Pot Tapebum" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_fungsional" id="tunj_fungsional" class="form-control" placeholder="Tunjangan Fungsional" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_jkk" id="pot_jkk" class="form-control" placeholder="Potongan JKK" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_kusus" id="tunj_kusus" class="form-control" placeholder="Tunjangan Khusus" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pot_jkm" id="pot_jkm" class="form-control" placeholder="Potongan JKM" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_terpencil" id="tunj_terpencil" class="form-control" placeholder="Tunjangan Terpencil" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="hutang" id="hutang" class="form-control" placeholder="Hutang / Lain" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tkd" id="tkd" class="form-control" placeholder="TKD" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="bulog" id="bulog" class="form-control" placeholder="BULOG" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_beras" id="tunj_beras" class="form-control" placeholder="Tunjangan Beras" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                </td>
                                <td ></td>
                                <td>
                                ...
                                <td>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="sewa" id="sewa" class="form-control" placeholder="Sewa Rumah" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                </td>
                            </tr>
                            <!-- baris 10  -->
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_pajak" id="tunj_pajak" class="form-control" placeholder="Tunjangan Pajak" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td ></td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="potongan" id="potongan" class="form-control" placeholder="POTONGAN" style="text-align: right;" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_bpjs" id="tunj_bpjs" class="form-control" placeholder="Tunjangan BPJS" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td class="4" ></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_jkk" id="tunj_jkk" class="form-control" placeholder="Tunjangan JKK" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td class="4" ></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="tunj_jkm" id="tunj_jkm" class="form-control" placeholder="Tunjangan JKM" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td class="4" ></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="pembulatan" id="pembulatan" class="form-control" placeholder="Pembulatan" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td class="4" ></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="jml_kotor" id="jml_kotor" class="form-control" placeholder="Jumlah Kotor" style="text-align: right;width: 70%" onkeyup="sum();" >
                                    </div>
                                    </div>
                                </td>
                                <td class="4" ></td>
                            ...
                            <tr><td colspan="4"></td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input name="jml_bersih" id="jml_bersih" class="form-control" placeholder="Jumlah Bersih" onkeypress="return angka(event);" style="text-align: right;" readonly="" >
                                    </div>
                                    </div>
                                </td>
                            </tr>
