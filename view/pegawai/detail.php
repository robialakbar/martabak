...
?>
            ...
            <section class="content">
             ...
             <a href="index.php?controller=berkas&method=select<?php echo $row_pegawai['nip'];?>" class="btn btn-md btn-info" data-toggle="tooltip" data-placement="top" title="Lampiran"><i class="fa fa-file-archive-o fa-fw"></i>Lampiran</a>
